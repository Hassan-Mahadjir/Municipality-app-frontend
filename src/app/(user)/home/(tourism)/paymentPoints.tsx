...
export default function PaymentPoints() {
	...
	const [filteredPoints, setFilteredPoints] = useState<PaymentValues[]>(pionts);
	...
	const handlePress = () => {
		const url =
			'https://www.google.com/maps/d/u/0/viewer?mid=1MOJS9QrCHWNZCqD-79OaEkiacqrNuAmC&femb=1&ll=35.24891578265986%2C33.669542874735434&z=10';
