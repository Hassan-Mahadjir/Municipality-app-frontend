import { View, Text, ScrollView, Image, Dimensions, FlatList, ListRenderItem, TextInput } from 'react-native'
    ...
    return (
        <View>
            ...
            <ScrollView style={{marginTop: 5}}>
                ...
                <Text style={{marginTop: 10, marginLeft: 15, fontSize: 20, color: '#F1722A'}}>Comments</Text>
                <View style={styles.box}>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/nf8qcuembn-192%3A1140?alt=media&token=b3104fa9-8c36-46af-b1e1-7923dd84795b'}} style={styles.userPic}/>
                    <Text style={styles.userText}>i_am_user</Text>
                    <Text style={styles.userText2}>11 contributions</Text>
                    <View style={{flexDirection: 'row'}}>
                        <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/ui0s3xdrmua-192%3A1095?alt=media&token=cfb3c95f-3117-4a1d-8c9b-4295dbdb12d7'}} style={[styles.smallstarImage, {marginLeft: 75}]}/>
                        <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/ui0s3xdrmua-192%3A1095?alt=media&token=cfb3c95f-3117-4a1d-8c9b-4295dbdb12d7'}} style={styles.smallstarImage}/>
                        <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/ui0s3xdrmua-192%3A1095?alt=media&token=cfb3c95f-3117-4a1d-8c9b-4295dbdb12d7'}} style={styles.smallstarImage}/>
                        <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/ui0s3xdrmua-192%3A1095?alt=media&token=cfb3c95f-3117-4a1d-8c9b-4295dbdb12d7'}} style={styles.smallstarImage}/>
                        <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/ui0s3xdrmua-192%3A1095?alt=media&token=cfb3c95f-3117-4a1d-8c9b-4295dbdb12d7'}} style={styles.smallstarImage}/>
                    </View>
                    <Text style={[styles.userTime, {marginTop: 10}]}>Commented: 10th May 2020</Text>
                    <Text style={styles.comment}>Best place I have visited in 
                            magusa yet, bike rides are 
                            amazing. Definitely recommend
                            everyone to visit.
                    </Text>
                </View>
                <View style={styles.box}>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/qz4cwqzdta-192%3A1141?alt=media&token=5499ecd4-58bc-4fd2-93b4-21afcda2c946'}} style={styles.userPic}/>
                    ...
                    <Text style={[styles.userTime, {marginTop: 10}]}>Commented: 9th Feb 2020</Text>
                    <Text style={styles.comment}>Cannot believe a town like this
                        was abandoned by its former
                        residents. Very spooky. Must 
                        visit. Go sight-seeing on...
                        </Text>
                    <Text style={{color: 'orange', marginLeft: 215}}>Read more</Text>
                </View>
                <View style={styles.box}>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/dz5iovsgol9-192%3A1142?alt=media&token=d3999b58-1a44-43d8-bf66-d3e3e19d7377'}} style={styles.userPic}/>
                    ...
                    <Text style={[styles.userTime, {marginTop: 10}]}>Commented: 29th Sept 2020</Text>
                    <Text style={styles.comment}>Went with friends. Had a good 
                        time. They took our ids and 
                        kept it for the whole time we 
                        were inside. Only part I didn’t 
                        enjoy.
                        </Text>
                </View>
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/7082gjtq1uv-195%3A1323?alt=media&token=b52d8bb2-91b5-4187-84c0-4e733c1fdd6c'}} style={styles.whitestars}/>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/7082gjtq1uv-195%3A1323?alt=media&token=b52d8bb2-91b5-4187-84c0-4e733c1fdd6c'}} style={styles.whitestars}/>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/7082gjtq1uv-195%3A1323?alt=media&token=b52d8bb2-91b5-4187-84c0-4e733c1fdd6c'}} style={styles.whitestars}/>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/7082gjtq1uv-195%3A1323?alt=media&token=b52d8bb2-91b5-4187-84c0-4e733c1fdd6c'}} style={styles.whitestars}/>
                    <Image source={{uri: 'https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/7082gjtq1uv-195%3A1323?alt=media&token=b52d8bb2-91b5-4187-84c0-4e733c1fdd6c'}} style={styles.whitestars}/>
