    ...
    <ScrollView>
      <View style={styles.headerContainer}>
        <View style={styles.logoutContainer}>
          {/* Use translated text for Logout */}
      ...
      <View style={{ marginTop: verticalScale(10), marginHorizontal: scale(10) }}>
        <View style={styles.settingsCard}>
          ...
          <View style={styles.settingsText}>
            ...
            <Text style={{ color: COLORS.gray }}>{t('makeChangesToAccount')}</Text>
          </View>
          <Pressable
            onPress={() =>
              router.push({
      ...
      <View style={{ marginTop: verticalScale(10), marginHorizontal: scale(10) }}>
        <View style={styles.settingsCard}>
          ...
          <View style={styles.settingsText}>
            <Text style={styles.settingsTitleText}>{t('password')}</Text>
            <Text style={{ color: COLORS.gray }}>{t('changePassword')}</Text>
          </View>
