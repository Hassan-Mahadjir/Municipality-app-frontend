	...
	return (
		<View style={styles.cardContainer}>
			...
			<View style={styles.dataContainer}>
				<Text style={[styles.columnText, { color: '#000' }]}>{data.time}</Text>
				<Text style={[styles.columnText, { color: '#000' }]}>{data.date}</Text>
				<Text style={[styles.columnText, { color: '#000' }]}>{data.with}</Text>
